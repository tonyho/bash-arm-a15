...
topdir = .
BUILD_DIR = /home/hexiongjun/iAuto2/bash/bash-4.3
top_builddir = /home/hexiongjun/iAuto2/bash/bash-4.3
srcdir = .
VPATH = .
...
SIZE = arm-poky-linux-gnueabi-size
...
LDFLAGS =  -L./lib/termcap $(STATIC_LD) $(LOCAL_LDFLAGS) $(PROFILE_FLAGS) $(CFLAGS)
LDFLAGS_FOR_BUILD =  $(LOCAL_LDFLAGS) $(CFLAGS_FOR_BUILD)
